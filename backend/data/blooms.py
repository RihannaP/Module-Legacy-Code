...
def get_blooms_for_user(
    ...
    with db_cursor() as cur:
        ...
        cur.execute(
            f"""SELECT
              b.id, u.username, b.content, b.send_timestamp, b.rebloom_id, ou.username as original_sender,
...
def get_blooms_with_hashtag(
    ...
    with db_cursor() as cur:
        cur.execute(
            f"""SELECT
              b.id, u.username, b.content, b.send_timestamp, b.send_timestamp, b.rebloom_id, ou.username as original_sender,
              (SELECT COUNT(*) FROM blooms WHERE rebloom_id = COALESCE(b.rebloom_id, b.id)) as rebloom_count
